...
public class Topic06_WebBrowser_WebElement {
	...
	public void TC01_VerifyUrl() {
		...
		//AssertJUnit.assertEquals(strUrlLP, "http://live.demoguru99.com/index.php/customer/account/login/");
		...
		//AssertJUnit.assertEquals(strUrlRP, "http://live.demoguru99.com/index.php/customer/account/create/");
	}
	@Test
