...
public class Topic_10_User_Interactions {
	...
	public void TC03_Hover_To_Element() {
		...
		action.moveToElement(driver.findElement(
				By.xpath("//div[@class='cdz-main-menu left-navigation hidden-xs']//span[(text()='Đồ ăn vặt')]")))
				.perform();
		sleepSecond(3);
		action.click(driver.findElement(By.xpath("//nav[@class='navigation cdz-fix-left']//a[text()='Ô mai']")))
				.perform();
		sleepSecond(5);
		Assert.assertEquals(driver.findElement(By.xpath("//span[@class='base']")).getText(), "Ô MAI");
		Assert.assertTrue(driver.findElement(By.xpath("//span[text()='Ô mai']")).isDisplayed());
	}
